...
public:
  ...
  void set_base(Pose3d_Node* base)
  {
    _base = base;
  }
  Pose3d_Node* base()
...
public:
  ...
  Pose3d_Pose3d_Factor(Pose3d_Node* pose1, Pose3d_Node* pose2,
    ...
    : FactorT<Pose3d>("Pose3d_Pose3d_Factor", 6, noise, measure)
    , _pose1(pose1)
    , _pose2(pose2)
  {
  ...
  void initialize()
  {
    require(_pose1->initialized() || _pose2->initialized(), "slam3d: "
                                                            "Pose3d_Pose3d_"
                                                            "Factor requires "
                                                            "pose1 or pose2 to "
                                                            "be initialized");
...
public:
  ...
  Pose3d_Point3d_Factor(Pose3d_Node* pose, Point3d_Node* point,
    ...
    : FactorT<Point3d>("Pose3d_Point3d_Factor", 3, noise, measure)
    , _pose(pose)
    , _point(point)
  {
    _nodes.resize(2);
  ...
  void initialize()
  {
    require(_pose->initialized(), "slam3d: Pose3d_Point3d_Factor requires pose "
                                  "to be initialized");
